...
func NewGame() *Game {
	...
	g.Ball = append(g.Ball, &Ball{X: 200, Y: 400, DX: 4, DY: 4})
	g.Ball = append(g.Ball, &Ball{X: 600, Y: 400, DX: -4, DY: -4})
...
func (g *Game) Draw(screen *ebiten.Image) {
	...
	for _, b := range g.Ball {
		vector.FillCircle(screen, float32(b.X), float32(b.Y), 10, ColorBall, true)
	}
}
